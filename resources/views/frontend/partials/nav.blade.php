<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-light">
  <div class="container">
    ...
    <a class="navbar-brand" href="{{ route('index') }}"><img src="{{asset('images/logo.png')}}" width="120px" height="48px" ></a>
        ...
        <li class="nav-item">
          <form class="form-inline my-2 my-lg-0" action="{!! route('search') !!}" method="get">
            ...
            <div class="input-group mb-3">
              <input type="text" size="50" class="form-control" name="search" placeholder="Search Products" aria-label="Recipient's username" aria-describedby="basic-addon2">
